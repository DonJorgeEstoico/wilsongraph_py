...
def generate_all_graphs(n):
    ...
    print(f"Posible edges at nodes: {possible_edges}")
    print(f"Posible edges at nodes: {len(possible_edges)}")
...
for i, G in enumerate(graphs[:min(len(graphs), 2)]): # Shows to 2 graphs
